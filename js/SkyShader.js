...
// SkyShader.js
// ------------------------------------------------------------------------------
// Influenced by Joshua Koo's lighting example, this is a shader based on
// Preetham's model using aerial perspectivefound here: 
// http://www.cs.utah.edu/~shirley/papers/sunsky/sunsky.pdf
//
// Also has parts inpsired from a powerpoint by Preetham and Hoffman found
// here: http://www2.ati.com/developer/gdc/GDC02_HoffmanPreetham.pdf
//
// Joshua Koo and Preetham Sky Shader: 
// https://github.com/zz85
// https://github.com/mrdoob/three.js/blob/master/examples/js/SkyShader.js
// 
// Joshua Koo used much of Simon Wallner's shader(s), which can be found here:
// http://www.simonwallner.at/projects/atmospheric-scattering
// https://github.com/SimonWallner/kocmoc-demo/tree/RTVIS/media/shaders
//
// The majority of the changes came from modifying the calculations to stay
// true to the ones provided in the Preetham powerpoint presentation along with
// interpolating the extinction, Fex, with 1 - Fex and the absolute value of the
// sun direction's y component. This resulted in more vibrant reds when the sun
// is setting and more vibrant blues at "high noon".
//
...
var SkyShader = function()
{
	...
	this.uniforms =
	{
		...
		turbidity:	 			{ type: "f", value: 1.2 },
		rayleighCoefficient: 	{ type: "f", value: 0.3 },
		mieCoefficient:	 		{ type: "f", value: 0.0017 },
	...
	[
		...
		"// Optical length at zenith for molecules and particles, respectively. (Preetham)",
		...
		"{",
			...
			"float zenithAngle = acos(max(0.0, dot(up, direction))); // Want to be < 90 to avoid singularity in distance calculation.",
			...
			"// Incoming light, or color, from object (or texture)",
